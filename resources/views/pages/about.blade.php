              ...
              <div class="row">
                <div class="col-lg-7">
                  <div class="">
                    ...
                    <p>
                      Selamat datang di Kampusdev, solusi terbaik untuk kebutuhan akademik koding kampus Anda. Kami memahami bahwa tugas kuliah, praktikum, dan skripsi seringkali menjadi tantangan besar bagi banyak mahasiswa. Dari tenggat waktu yang ketat hingga kompleksitas materi, menjalani kehidupan akademik memang tidak selalu mudah. Oleh karena itu, kami hadir untuk memberikan bantuan yang Anda butuhkan dengan profesionalisme dan kualitas tinggi.
                    </p>
                  </div>
                </div>
                <div class="col-lg-5">
                  <img
                    src="{{asset('assets/fontpage/images/other/about.jpeg')}}"
                    alt="Katen Doe"
                    class="rounded mb-4"
                  />
                </div>
                <div class="col-lg-12">
                  <p>
                    Kami hadir untuk untuk berdedikasi dalam membantu menyediakan berbagai program dan solusi yang inovatif di bidang teknologi dan edukasi. Dengan pengalaman bertahun-tahun dan tim yang ahli di bidangnya, kami menawarkan layanan yang dapat membantu Anda dalam berbagai proyek akademik dan penelitian dengan teknologi yang fleksibel dan terbaru.
                  </p>
                </div>
              </div>
              ...
              >
                <div class="list">
                  <div class="item" style="--position: 1">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_1.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 2">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_2.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 3">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_3.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 4">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_4.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 5">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_5.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 6">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_6.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 7">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_7.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 8">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_8.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 9">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_9.png')}}" alt="" />
                  </div>
                  <div class="item" style="--position: 10">
                    <img src="{{asset('assets/fontpage/images/slider/images/slider1_10.pn')}}g" alt="" />
                  </div>
                </div>
              </div>
