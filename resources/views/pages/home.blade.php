...
@section('content')
    <div class="">
        <h4>Halo, selamat sore.. <br> lagi cari projek apa hari ini?</h4>
    </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="widget rounded mt-5">
                <div class="widget-about data-bg-image text-center" data-bg-image="images/map-bg.png">
                    ...
                    <p class="mb-4">Hello.. tidak menemukan projek yang kamu cari? atau butuh jasa pembuatan website untuk
                            ...
                            <div class="post post-list-sm circle">
                                ...
                                <div class="details clearfix">
                                    <h6 class="post-title my-0">
                                        <a href="{{ route('project.detail', $popular->slug) }}">{{ $popular->title }}</a>
                                    </h6>
                                    <ul class="meta list-inline mt-1 mb-0">
                                        <li class="list-inline-item">{{ $popular->visit_count_total }} kali dilihat</li>
                                    </ul>
                                </div>
                            </div>
                        @endforeach
